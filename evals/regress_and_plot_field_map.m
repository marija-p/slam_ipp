...
gp_params.cov_func_UI = ...
    {@covUI, gp_params.cov_func, gp_params.N_gauss, diag([0.01,0.01,0.01])};

[ymu, ys, ~, ~, ~ , ~] = gp(gp_params.hyp_trained, ...
    gp_params.inf_func, gp_params.mean_func, gp_params.cov_func_UI, gp_params.lik_func, ...
