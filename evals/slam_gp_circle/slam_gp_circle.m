function [metrics] = slam_gp_circle(traj_points, map_params, ...
    planning_params, opt_params, gp_params, training_data, gt_data, testing_data)
...
userData_graph_gp_3d_circle;
Robot{1}.positionStd = planning_params.position_stdev';
Robot{1}.position = traj_points(:,1);
% Draw figures for this experiment.
FigOpt.drawFigs = 1;
...
% Planning parameters
trajectory = plan_path_waypoints(traj_points', planning_params.max_vel, ...
