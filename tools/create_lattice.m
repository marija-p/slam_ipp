...
[X,Y,Z] = ...
    meshgrid(linspace(map_params.pos_x,map_params.pos_x+dim_x_env,planning_params.lattice_points_x), ...
    linspace(map_params.pos_y,map_params.pos_y+dim_x_env,planning_params.lattice_points_y), ...
    linspace(map_params.pos_z,map_params.pos_z+dim_z_env,planning_params.lattice_points_z));
